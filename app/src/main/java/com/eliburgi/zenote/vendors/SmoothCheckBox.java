...
public class SmoothCheckBox extends View implements Checkable {
    ...
    public void setCheckedColor(int colorResId) {
        mCheckedColor = colorResId;
    }

    public void setStrokeColor(int colorResId) {
        mFloorColor = colorResId;
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_scb_stroke_width, CompatUtils.dp2px(getContext(), 0));
        ta.recycle();
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        Log.i("SmoothCheckBox", "onSaveInstanceState: SAVED");
        return bundle;
    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            Log.i("SmoothCheckBox", "onSaveInstanceState: RESTORE");
